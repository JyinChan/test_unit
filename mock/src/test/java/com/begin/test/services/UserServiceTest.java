package com.begin.test.services;

import com.alibaba.fastjson.JSON;
import com.begin.test.IdGenerator;
import com.begin.test.dao.UserDAO;
import com.begin.test.models.UserDO;
import com.begin.test.models.UserVO;
...
public class UserServiceTest {
    ...
    public void testCreateUserWithNew() {
        ...
        // 调用被测方法
        String text = "{\"name\":\"test\"}";//ResourceHelper.getResourceAsString(getClass(), "userCreateVO.json");
        ...
        text = "{\"id\":1,\"name\":\"test\"}";//ResourceHelper.getResourceAsString(getClass(), "userCreateDO.json");
    ...
    public void testCreateUserWithOld() {
        ...
        // 调用被测方法
        String text = "{\"id\":1,\"name\":\"test\"}";//ResourceHelper.getResourceAsString(getClass(), "userCreateVO.json");
        UserVO userCreate = JSON.parseObject(text, UserVO.class);
        Assert.assertEquals("用户标识不一致", userId, userService.createUser(userCreate));
        ...
        text = "{\"id\":1,\"name\":\"test\"}";//ResourceHelper.getResourceAsString(getClass(), "userModifyDO.json");
    ...
    public void testCreateUserWithException() {
        ...
        UserVO userCreate = JSON.parseObject(text, UserVO.class);
        /*
        UnsupportedOperationException exception = org.testng.Assert.assertThrows("返回异常不一致",
